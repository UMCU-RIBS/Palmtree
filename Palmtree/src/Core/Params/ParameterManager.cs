...
namespace Palmtree.Core.Params {
    ...
    public static class ParameterManager {
        ...
        private static Dictionary<string, Parameters> parameterSets = new Dictionary<string, Parameters>(0);            // parameter-sets are stored as name (key) and Parameter (object) pairs in a dictionary, Dictionary collections are thread-safe (all calls in this class refer to this dictionary object)
